@10519  field_decl       name: @10537   type: @10538   scpe: @10431 srcp: tcp.h:93                chain: @10539 bitfield       size: @10540   algn: 1 bpos: @757     addr: 7f81279f75f0
@1      type_decl        name: @2       type: @3       chain: @4 addr: 7f6cc2ca8390
@9      integer_cst      type: @17      low : 240
@10519  field_decl       name: @10537   type: @10538   scpe: @10431 srcp: tcp.h:93                chain: @10539 bitfield       size: @10540   algn: 1 bpos: @757     addr: 7f81279f75f0
@10519  field_decl       name: @10537   type: @10538   scpe: @10431 srcp: tcp.h:93                chain: @10539 bitfield       size: @10540   algn: 1 bpos: @757     addr: 7f81279f75f0
@3479   binfo            type: @3025    spec: virt     bases: 1 accs: pub      binf: @4092
@5117   field_decl       name: @6216    type: @6217    scpe: @3139 srcp: node.hxx:89             chain: @6218 accs: priv     bitfield       size: @6219 algn: 1        bpos: @56
@80410  constructor      lngt: 0
@279    function_decl    name: @277     type: @243     scpe: @200 srcp: stl_queue.h:304         note: operator le             note: pseudo tmpl args: @333     body: undefined link: extern   body: @334
@1      type_decl        name: @2       type: @3       chain: @4 addr: 7f6cc2ca8390
...
@80410  constructor      lngt: 0
@3479   binfo            type: @3025    spec: virt     bases: 1 accs: pub      binf: @4092
@132417 constructor      lngt: 5        val : @142779  val : @142780 val : @142781  val : @142782  val : @142783
@331    function_decl    name: @329     type: @243     scpe: @200 srcp: stl_queue.h:298         note: operator gt             note: pseudo tmpl args: @393     body: undefined link: extern   body: @394
@1      type_decl        name: @2       type: @3       chain: @4 addr: 7f6cc2ca8390
@21     integer_cst      type: @18      high: -1       low : -128
@3479   binfo            type: @3025    spec: virt     bases: 1 accs: pub      binf: @4092
@21     integer_cst      type: @18      high: -1       low : -128
