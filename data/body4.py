...
function_decl(
    ...
    body=bind_expr(
        body=statement_list(
            ...
            E3=call_expr(
                fn=addr_expr(
                    OP0=pointer_type(algn='64',ptd='5191',size='22'),
                ...
                OP1=statement_list(
                    E0=modify_expr(
                        ...
                        OP1=call_expr(
                            E0=nop_expr(
                                OP0=addr_expr(
                                    OP0=pointer_type(algn='64',ptd='13022',size='22'),
                                    type=string_cst(string='PROMPT_COMMAND'))),
                            fn=addr_expr(
                                OP0=pointer_type(algn='64',ptd='5268',size='22'),
                        ...
                        OP1=call_expr(
                            ...
                            E1=nop_expr(
                                OP0=addr_expr(
                                    ...
                                    type=string_cst(string='PROMPT_COMMAND'))),
                            fn=addr_expr(
                                OP0=pointer_type(algn='64',ptd='10721',size='22'),
                                                       ...
                                                       body=statement_list(
                                                           ...
                                                           E3=modify_expr(
                                                               ...
                                                               OP1=call_expr(
                                                                   E0=nop_expr(
                                                                       OP0=addr_expr(
                                                                           OP0=pointer_type(algn='64',ptd='1702',size='22'),
                                                               ...
                                                               OP1=modify_expr(
                                                                   ...
                                                                   OP1=modify_expr(
                                                                       ...
                                                                       OP1=call_expr(
                                                                           E0=nop_expr(
                                                                               OP0=addr_expr(
                                                                                   OP0=pointer_type(algn='64',ptd='9701',size='22'),
                                                                                   type=string_cst(string='eterm'))),
                                                                           fn=addr_expr(
                                                                               OP0=pointer_type(algn='64',ptd='2882',size='22'),
                                                           ...
                                                           E5=call_expr(
                                                               ...
                                                               E2=var_decl(algn='64',size='22',srcp='eval.c:201',used='1',
                                                                           name=identifier_node(string='pwd')),
                                                               fn=addr_expr(
                                                                   OP0=pointer_type(algn='64',ptd='2041',size='22'),
                                                           ...
                                                           E6=call_expr(
                                                               ...
                                                               E1=nop_expr(
                                                                   OP0=addr_expr(
                                                                       OP0=pointer_type(algn='64',ptd='9702',size='22'),
                                                                       type=string_cst(string='../eval.c'))),
                                                               E2=integer_cst(low='208'),
                                                               fn=addr_expr(
                                                                   OP0=pointer_type(algn='64',ptd='5837',size='22'),
            ...
            E6=modify_expr(
                ...
                OP1=call_expr(
                    fn=addr_expr(
                        OP0=pointer_type(algn='64',ptd='2560',size='22'),
